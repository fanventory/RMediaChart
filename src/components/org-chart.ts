...
import { randomColor, getColorStrFromCanvas } from './color-util'
  ...
  drawShowCanvas() {
    ...
    this.virtualContainerNode.selectAll('.orgUnit').each(function () {
      ...
      Util.text(
        ...
        data.work,
        indexX + self.unitPadding,
        indexY + 6 * self.unitYPadding,
        '20px',
        '#fff'
      )
      // Util.text(self.context, data.work, indexX + self.unitPadding, indexY + self.unitPadding + 30, '20px', '#000000')
